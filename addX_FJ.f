...
!!!!!!!!!!!!!!!!!!!!initialization call to user subroutine!!!!!!!!!!!!!!
        INIT = 0
      call XHOCL (WW,TT,XP,XM, X,INIT,TITLNEW)



!---synchronize with the HOCL cross sections (whether done or not)
...
!!!!!!!!!!!!!!!!!!!primary high-resolution wavelength loop!!!!!!!!!!!!!!
       do J = K1,K2
        ...
        call XHOCL (W(J), TT,XP,XM, XNEW, INIT, TITLNEW)
...
!-----------------------------------------------------------------------
      subroutine XHOCL (WW,TT,PP,MM, XXWT,INIT, TITLNEW)
!-----------------------------------------------------------------------
!   WW = wavelength (nm)
